...
#define LED_DRIVER_TLC5916_GPIO_SDI		(12)
#define LED_DRIVER_TLC5916_GPIO_CLK		(14)
#define LED_DRIVER_TLC5916_GPIO_LE		(13)
#define LED_DRIVER_TLC5916_GPIO_OE		(5)

#define LED_DRIVER_TLC5916_NUM				(1)
#define LED_DRIVER_TLC5916_CLK_DELAY_MS		(10)
